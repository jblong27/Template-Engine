...
function promptEngineers(answers) {
    ...
    inquirer.prompt([
        ...
        },
        {
            type: "input",
            name: "engEmail",
            message: `What is the #${i} engineer's email?`
        },
        {
            type: "input",
            name: "engGithub",
        ...
        if (i >= answers.engAmount) {
            ...
            i = 0;
            // checking to see if there are any interns
...
function promptInterns(answers) {
    ...
    inquirer.prompt([
        ...
        },
        {
            type: "input",
            name: "intEmail",
            message: `What is the #${i} intern's email?`
        },
        {
            type: "input",
            name: "intSchool",
...
const writeFile = function(answers) {
    ...
    writeFileAsync(__dirname + "/team.html", html);
}
